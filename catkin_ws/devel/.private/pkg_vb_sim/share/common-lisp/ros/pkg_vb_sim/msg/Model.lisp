...
(cl:defmethod cl:initialize-instance :after ((m <Model>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Model)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_vb_sim-msg:<Model> is deprecated: use pkg_vb_sim-msg:Model instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Model>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_vb_sim-msg:type-val is deprecated.  Use pkg_vb_sim-msg:type instead.")
  (type m))
