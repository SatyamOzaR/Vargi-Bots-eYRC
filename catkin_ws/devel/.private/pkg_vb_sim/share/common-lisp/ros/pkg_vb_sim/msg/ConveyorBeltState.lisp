...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_vb_sim-msg:<ConveyorBeltState> is deprecated: use pkg_vb_sim-msg:ConveyorBeltState instead.")))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <ConveyorBeltState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_vb_sim-msg:power-val is deprecated.  Use pkg_vb_sim-msg:power instead.")
  (power m))

(cl:ensure-generic-function 'enabled-val :lambda-list '(m))
(cl:defmethod enabled-val ((m <ConveyorBeltState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_vb_sim-msg:enabled-val is deprecated.  Use pkg_vb_sim-msg:enabled instead.")
  (enabled m))
