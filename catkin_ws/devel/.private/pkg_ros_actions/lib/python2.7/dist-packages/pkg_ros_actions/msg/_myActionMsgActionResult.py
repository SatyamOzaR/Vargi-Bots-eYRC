...
"""autogenerated by genpy from pkg_ros_actions/myActionMsgActionResult.msg. Do not edit."""
import codecs
import sys
...
class myActionMsgActionResult(genpy.Message):
  _md5sum = "9947ff0cda32e84a022d3d6978fa6c68"
  _type = "pkg_ros_actions/myActionMsgActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pkg_ros_actions/myActionMsgResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(myActionMsgActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pkg_ros_actions.msg.myActionMsgResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pkg_ros_actions.msg.myActionMsgResult()
