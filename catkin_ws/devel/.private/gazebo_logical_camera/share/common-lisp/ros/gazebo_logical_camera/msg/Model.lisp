...
(cl:defmethod cl:initialize-instance :after ((m <Model>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Model)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_logical_camera-msg:<Model> is deprecated: use gazebo_logical_camera-msg:Model instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Model>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_logical_camera-msg:type-val is deprecated.  Use gazebo_logical_camera-msg:type instead.")
  (type m))
