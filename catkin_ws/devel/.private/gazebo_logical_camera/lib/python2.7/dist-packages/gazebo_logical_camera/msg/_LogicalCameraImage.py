...
"""autogenerated by genpy from gazebo_logical_camera/LogicalCameraImage.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['gazebo_logical_camera/Model[]','geometry_msgs/Pose']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = gazebo_logical_camera.msg.Model()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
